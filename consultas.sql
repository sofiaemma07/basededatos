...
SELECT c.nombre_cliente, e.nombre AS 'nombre_rep', e.apellido1 AS 'apellido_rep' 
FROM cliente c 
JOIN empleado e  
ON c.codigo_empleado_rep_ventas = e.codigo_empleado
WHERE e.nombre = 'Lorena' AND e.apellido1 = 'Paxton';

2. Devuelve un listado indicando todas las ciudades donde hay oficinas y el número de empleado
que tiene.

SELECT o.ciudad, e.nombre AS 'nombre_empleado', e.apellido1 AS 'apellido_empleado'
FROM oficina o
JOIN empleado e 
